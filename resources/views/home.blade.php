      ...
      <div class="row">
        <div class="col-md-3">
          ...
          <br>
            ...
            <a style="cursor:pointer;" id="btnVerFrmPromocion" class="list-group-item"><span class="glyphicon glyphicon-bookmark" aria-hidden="true"></span> Promociones <span id="spanCountPromocion" class="badge">..</span></a>
            <a style="cursor:pointer;" id="btnVerFrmkits" class="list-group-item"><span class="glyphicon glyphicon-bookmark" aria-hidden="true"></span> Kits<span id="spanCountKit" class="badge">..</span></a>
            ...
            <a style="cursor:pointer;" id="" class="list-group-item"><span class="glyphicon glyphicon-paperclip" aria-hidden="true"></span> Reportes <span class="badge">..</span></a>
          </div>
